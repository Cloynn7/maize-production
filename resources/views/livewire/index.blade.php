<div>
    <!-- Hero Section -->
    <section class="relative bg-cover bg-center bg-fixed bg-no-repeat h-[900px] flex items-center"
        ...
        <div class="mx-auto text-center text-white relative z-10">
            ...
            <p class="text-lg md:text-xl lg:text-2xl mb-8 max-w-3xl mx-auto">Lorem ipsum dolor sit amet consectetur
                ...
                culpa.</p>
            <a href="#" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"><i
    ...
    <!-- Content Section -->
    <section>
        <section class="bg-gray-300 py-4 md:py-16 px-4">
            <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between">
                ...
                <div class="lg:w-1/2">
                    ...
                    <p class="text-gray-700 leading-relaxed mb-6">Fusce ullamcorper, felis non congue luctus, ex enim
                        ...
                        et eros.</p>
                    <a href="#"
                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">:v</a>
                </div>
            </div>
        </section>
        ...
        <button id="goToTopBtn"
            class="hidden fixed bottom-4 right-4 bg-blue-500 text-white px-4 py-2 rounded cursor-pointer">
