<div class="fixed inset-0 md:left-64 z-30 flex items-center justify-center overflow-auto bg-black bg-opacity-50" x-cloak
    x-show="newDiscountModal">
    <div class="w-[400px] md:w-[500px] lg:w-[600px] h-auto px-6 py-4 mx-4 md:mx-auto text-left bg-white rounded shadow-lg"
        @click.away="newDiscountModal = false" x-transition:enter="motion-safe:ease-out duration-300"
        x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100">
        <div class="flex items-center justify-between mb-4">
            <h5 class="text-black text-lg font-semibold">Create new discount code</h5>
            <button type="button" class="cursor-pointer" @click="newDiscountModal = false">
        ...
        @endif
        <div>
            <form class="grid grid-cols-1 gap-4" wire:submit="createCode" method="POST">
                @csrf
                <div>
